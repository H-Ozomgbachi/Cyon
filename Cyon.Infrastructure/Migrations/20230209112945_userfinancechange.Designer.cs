...
namespace Cyon.Infrastructure.Migrations
{
    ...
    [Migration("20230209112945_userfinancechange")]
    partial class userfinancechange
    {
            ...
            modelBuilder.Entity("Cyon.Domain.Entities.Announcement", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 9, 12, 29, 45, 409, DateTimeKind.Local).AddTicks(4176));
            ...
            modelBuilder.Entity("Cyon.Domain.Entities.Chaplain", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 9, 12, 29, 45, 409, DateTimeKind.Local).AddTicks(3559));
            ...
            modelBuilder.Entity("Cyon.Domain.Entities.OrganisationFinance", b =>
                {
                    ...
                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 9, 11, 29, 45, 409, DateTimeKind.Utc).AddTicks(7798));
            ...
            modelBuilder.Entity("Cyon.Domain.Entities.UserFinance", b =>
                {
                    ...
                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 9, 12, 29, 45, 409, DateTimeKind.Local).AddTicks(7267));
